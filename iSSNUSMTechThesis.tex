...
\hspace{.05cm} {\bf {X.Y. Zee, PhD}}\\
\hspace{.05cm} {\sc and}\\
\hspace{.05cm} {\bf {A.B. Cee, MSc}}\\
\vspace{0.5cm}
\vspace{0.5cm}
%\universityseal\ \\
...
{\centering {\includegraphics[width=0.5\linewidth,angle=0]{logo/iss_nus_logo.jpg}}\par}
\end{figure}
...
{\color{black} \centering \sc{\small Singapore, October 2014}}
