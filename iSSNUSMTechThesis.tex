...
%% National University of Singapore, hereafter, the University, though the same is not guaranteed
...
{\color{blue} \sc{project report submitted in partial fulfillment\\ for the requirements of the degree of}} \\
\vskip 0.5cm
...
{\color{blue} \sc{under the guidance of}} \\
\vspace{.5cm}

\hspace{.05cm} {\bf {Prof. XY Zee}}\\
\hspace{.05cm} {\sc and}\\
\hspace{.05cm} {\bf {A.B. Cee}}\\
\vspace{0.5cm}
\vspace{0.5cm}
%\universityseal\ \\
...
%\hspace{6cm}
%\vspace{5cm}
{\centering {\includegraphics[width=0.5\linewidth,angle=0]{logo/nus_logo.jpg}}\par}
\end{figure}

%\vskip{0.5cm}

%\large{\bf Department of Mathematics \& Computing} \\
\large{\color{blue} INSTITUTE OF SYSTEM SCIENCE} \\
%\vskip 0. 5cm
%\Large{\bf Indian Institute of Technology Guwahati}\\
\Large{\color{blue} \bf NATIONAL UNIVERSITY OF SINGAPORE}\\
%\vskip 0.50cm
{\color{blue} \centering \sc{Singapore, October 2014}}
...
It is certified that the work contained in this report entitled {\bf Title of the project} has been carried out by {\bf Name of Candidate} under our supervision as Capstone Project from July 2014 to November 2014 and that in our opinion is fully adequate, in scope and quality, as a dissertation for the degree of {\sc M.Tech.}.\\
\vspace*{0.5cm}\\
...
{\centering {
\includegraphics[width=0.4\linewidth,angle=0]{logo/Seal_Placeholder.png}
}\par}
